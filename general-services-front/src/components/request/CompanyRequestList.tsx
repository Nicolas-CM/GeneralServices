...
const CompanyRequestList = () => {
  ...
  } = useSelector((state: any) => state.requests);
  ...
  const [selectedRequestToCancel, setSelectedRequestToCancel] = useState<string>('');
  const [isRejectAction, setIsRejectAction] = useState<boolean>(false);
            ...
            onClick={() => {
              ...
              if (request) {
                if (isRejectAction) {
                  ...
                  dispatch(rejectRequest(selectedRequestToCancel as string));
                } else {
                  dispatch(
